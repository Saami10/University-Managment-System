...
public class AddStudent implements ActionListener {
    ...
    long first4=(ran.nextLong() % 9000)+1000;
    ...
    public AddStudent(){
        ...
        id15.setLayout(null);
        ImageIcon im=new ImageIcon(ClassLoader.getSystemResource("com/company/icons/download.jpg"));
        Image img=im.getImage().getScaledInstance(1220,700,Image.SCALE_DEFAULT);
        ...
        id2.setFont(new Font("serif",Font.ITALIC,25));
        id15.add(id2);
        ...
        id3.setFont(new Font("serif",Font.ITALIC,25));
        id15.add(id3);
        ...
        id4.setFont(new Font("serif",Font.ITALIC,25));
        id15.add(id4);
